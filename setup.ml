...
(* OASIS_START *)
(* DO NOT EDIT (digest: aa8caba3e6cd456a464323080c0a2d16) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          license =
            OASISLicense.DEP5License
              (OASISLicense.DEP5Unit
                 {
                    OASISLicense.license = "BSD-4-clause";
                    excption = None;
          ...
          homepage = Some "https://github.com/rgeoghegan/ocaml-redis";
          bugreports = None;
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "git://git@github.com:issuu/ocaml-redis.git";
                      src_repo_browser =
                        Some "https://github.com/issuu/ocaml-redis";
     ...
     oasis_version = "0.4.7";
     oasis_digest = Some "¾õV\149\024\025\149\002£\143\018T®p·D";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
